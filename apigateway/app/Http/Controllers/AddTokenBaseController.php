...
class AddTokenBaseController extends Controller
{
    ...
    public function action($data) 
    {
        ...
        $response_arr = [
            ...
            'title' => 'Получение токена по тарифу «Базовый» от сервиса criticalcss.ru',
            'subject' => 'Получение токена по тарифу «Базовый» от сервиса criticalcss.ru',
